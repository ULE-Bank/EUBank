			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-2">
						<form:form role="form" method="post" modelAttribute="reversemortgage"
							id="servicesform">
							<div id="register-form" class="register-form">
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											<i class="fa fa-eur"></i>
											<form:input type="text" name="name" path="valueValuation" />
										</div>
									</div>
								...
								<div class="row">
									<div class="section-field col-md-8">
										<form:errors style="color: red;" path="valueValuation"></form:errors>
									</div>
								</div>
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											...
											<form:input type="text" name="name" path="age" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											...
											<form:input type="text" name="name" path="percentageOverValuation" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
								...
								<div class="row">
									<div class="section-field col-md-8">
										<form:errors style="color: red;" path="percentageOverValuation"></form:errors>
									</div>
								</div>
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											<i class="fa fa-percent"></i>
											<form:input type="text" name="name" path="interestLoanRate" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
								...
								<div class="row">
									<div class="section-field col-md-8">
										<form:errors style="color: red;" path="interestLoanRate"></form:errors>
									</div>
								</div>
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											<i class="fa fa-percent"></i>
											<form:input type="text" name="name" path="openingComission" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											<i class="fa fa-percent"></i>
											<form:input type="text" name="name" path="rentProfitability" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
								...
								<div class="row">
									<div class="section-field col-md-8">
										<form:errors style="color: red;" path="rentProfitability"></form:errors>
									</div>
								</div>
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											<i class="fa fa-eur"></i>
											<form:input type="text" name="name" path="valuationCost" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
								...
								<div class="row">
									<div class="section-field col-md-8">
										<form:errors style="color: red;" path="valuationCost"></form:errors>
									</div>
								</div>
								...
								<div class="row">
									<div class="section-field col-md-8">
										<div class="field-widget">
											<i class="fa fa-eur"></i>
											<form:input type="text" name="name" path="formalizationExpenses" />
										</div>
									</div>
									<div class="section-field col-md-1">
										<span class="tooltip-content text-blue"
								...
								<div class="row">
									<div class="section-field col-md-8">
										<form:errors style="color: red;" path="formalizationExpenses"></form:errors>
									</div>
								</div>
