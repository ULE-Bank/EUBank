...
<html>
   <head>
      ...
      <meta name="author" content="Razvan Raducu, Camino Fernández, David Fernandez ">
   ...
   <body>
      <div class="page-wrapper">
         ...
         <section class="white-bg page-section-ptb" id="clientes">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <b> Número de cuenta:</b> ${account.accountNumber}
                  </div>
                  <div class="col-md-4">
                     <b> Fecha de alta:</b> 
                  ...
                  <div class="col-md-6">
                     <b> Saldo:</b> ${account.totalBalance}€
                  </div>
                  <div class="row">
                     <hr/>
                     <div class="row">
                        ...
                        <div style="height:450px; overflow:auto;">
						   <form id="liquidarForm" method="post">
							   <input id="deletedMovementNumber" name="deletedMovementNumber" type="text" style="display: none"/>
							   <input id="submit_handle_deleteMovement" type="submit" style="display: none" />
						   </form>
                           <table border="1" id="table-movements" class="col-md-12" >
                              ...
                              <c:forEach var="movement" items="${account.movements}">
                                 <tr>
                                    <td class="text-center">${movement.value}</td>
                                    <td class="text-center">${movement.concept}</td>
                                    <td class="text-center">
                                       <fmt:formatDate value="${movement.valueDate}" pattern="dd-MM-yyyy"/>
                                    </td>
                                    <td class="text-center">
                                       <c:choose>
                                          <c:when test = "${movement.operation == 'I' }">
                                             Ingreso
                                          </c:when>
                                          <c:when test = "${movement.operation == 'D' }">
                                             Disposición
                                          </c:when>
                                          <c:otherwise>
                                             No especificado
                                    ...
                                    <td class="delMovement text-center">       			 		 
                                    </td>
                                 </tr>
                              </c:forEach>
                           </table>
                     ...
                     <div class="section-field col-md-12 register-form">
                        <form:form role="form" method="post" modelAttribute="subledgerAccount"
                           id="servicesform">
                           <div id="moves-container">
                              ...
                              <div class="row"
                                 ...
                                 <div class="section-field col-md-4">
                                    <label for="movements[0].concept">
                                       <spring:message
                                          code="label.s7c1" />
                                    </label>
                                    <div class="field-widget">
                                       <i class="fa fa-pencil"></i>
                                       <form:input path="movements[0].concept"
                                          required="required" />
                                    </div>
                                    <form:errors  style="color:red;" path="movements[0].concept"/>
                                 </div>
                                 <div class="section-field col-md-3">
                                    <label for="movements[0].value">
                                       <spring:message
                                          code="label.s7c2" />
                                    </label>
                                    <div class="field-widget">
                                       <i class="fa fa-eur"></i>
                                       <form:input path="movements[0].value"
                                          required="required" />
                                    </div>
                                    <form:errors  style="color:red;" path="movements[0].value"/>
                                 </div>
                                 <div class="section-field col-md-3">
                                    <label for="movements[0].valueDate">
                                       <spring:message
                                          code="label.s7c3" />
                                    </label>
                                    <div class="field-widget">
                                       <i class="fa fa-calendar"></i> <input type="date"
                                          id="movements0.valueDate"
                                          name="movements[0].valueDate" required="required" />
                                    </div>
                                    <form:errors  style="color:red;" path="movements[0].valueDate"/>
                                 </div>
                                 <div class="section-field col-md-2">
                                    <label for="movements[0].operation">
                                       <spring:message
                                          code="label.operation" />
                                    </label>
                                    <div class="field-widget">
                                       <form:select path="movements[0].operation"
                                          class="selected">
                                          <form:option value="D" label="${variable1}" />
                                          <form:option value="I" label="${variable2}" />
                                       </form:select>
                                    </div>
                                    <form:errors style="color:red;" path="movements[0].operation"/>
                                 </div>
                              </div>
                           </div>
                           <p>
                        ...
                        <form id="liquidarForm" method="POST">
                           <div class="row">
                              <div class="col-md-6 col-md-offset-3">
                                 ...
                                 <div class="col-md-6">
                                    <input type="date"
                                       id="initLiquidationDate"
                                       name="initLiquidationDate" required="required" />
                                 </div>
                              </div>
                              <br>
                              <br>
                              <div class="col-md-6 col-md-offset-3">
                                 ...
                                 <div class="col-md-6">
                                    <input type="date"
                                       id="finalLiquidationDate"
                                       name="finalLiquidationDate" required="required" />
                                 </div>
                              </div>
                           </div>
                           <div class="row text-center">
                              <a class="button mt-20" id="liquidarFormulario" onclick="liquidate()"> <span> Liquidar </span> <i class ="fa fa-calculator"></i></a>
                  ...
                  <a href="/o/u?uin=${account.dni}" class="button mt-20"  > <span> Volver al expediente electrónico </span> <i class ="fa fa-step-backward"></i></a>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
      				 <div class="modal-body">
						...
						<table class="table" style="background-color:white; ">
							...
							<tbody  style="font-size:13px; text-align:right;">
								<c:forEach var="row" items="${table}">
									<tr>
										<c:forEach var="itemRow" items="${row}">
											<td><c:out value="${itemRow}" /></td>
										</c:forEach>
									</tr>
								</c:forEach>
							</tbody>
						...
						<tbody style=" text-align:right;">
									<tr>
										...
										<td>${account.creditorInterests}%</td>
										<td>${account.finalCreditorInterests}</td>
									</tr>
									<tr>
										<td>Retencion rendimientos</td>
										<td>${account.capitalPerformanceRetention}%</td>
										<td>${account.finalPerformanceRetention}</td>
									</tr>
									<tr>
										<td>Intereses deudores</td>
										<td>${account.debtorInterestOverNegativeBalance}%</td>
										<td>${account.finalDebtorInterests}</td>
									</tr>
									<tr>
										<td>Comisión mantenimiento</td>
										<td>${account.maintenanceComission}€</td>
										<td>${account.maintenanceComission}€</td>
									</tr>
									<tr>
										<td>Comisión descubierto</td>
										<td>${account.maintenanceDeficit}%</td>
										<td>${account.finalDeficitComission}</td>
									</tr>
									<tr>
										<td></td>
										<td><b>TOTAL</b></td>
										<td>${account.totalLiquidation}</td>
									</tr>
								</tbody>
						</table>
         			...
         			<div class="modal-footer">
         			        <div class="row text-center">
	         			 		 <a class="button mt-20" id="liquidarFormulario" onclick="liquidatePersistent()"><span> Generar liquidacion </span> <i class ="fa fa-plus"></i></a>
	                        	  <p class="col-md-12" id="liquidationDateChecker"> <span> Fecha de liquidación seleccionada no coincide con la ultima fecha de liquidacion: ${account.lastLiquidation} <br> Liquidación no permanente </span> </p>
	                        </div>
	                        <div class="row text-center">
								<a class="button mt-20" id="closeModal" onclick="closeModal()"><span> Descartar cambios </span> <i class ="fa fa-plus"></i></a>
							</div>
					</div>
         		</div>
			</div>
      ...
      <script type="text/javascript">
         ...
         function liquidatePersistent(){
        	 var cookie = $.cookie('resultados')
        	 document.cookie = "persist=true";
        	 liquidate();
         }
         ...
         function deleteMovement(movementID) {
        	document.getElementById("deletedMovementNumber").value = movementID;
          	$("#submit_handle_deleteMovement").click();
          }
          
    	 var buttonsForDeleteMovement = document.getElementsByClassName("delMovement");
	     for(var i = 0; i < buttonsForDeleteMovement.length; i++){
	    	 var button = '<a class="button mt-10 button-black deleteMovement" id="deletedMovement' + i + '" onclick="deleteMovement('+ i +')"><span> X </span></a>';
	    	 buttonsForDeleteMovement[i].innerHTML = button;
	     } 
