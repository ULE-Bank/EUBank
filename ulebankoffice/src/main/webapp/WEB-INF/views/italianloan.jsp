...
<!-- CONSTRUCCIÓN DEL CHART DEL MÉTODO ITALIANO -->
                ...
                var data = {
                    ...
                    datasets: [
                        ...
                        },
                        {
                            ...
                            data: [7500, 6750, 6000, 5250, 4500, 3750, 3000, 2250, 1500, 750]
                        }
                    ]
                };
				...
				<div class="row text-center intro-title">
					...
					<ul class="page-breadcrumb">
						...
						<li><a href="/loans"><spring:message
							...
							class="fa fa-angle-double-right"></i></li>
						<li><span><spring:message code="label.s4italian" /></span></li>
					</ul>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-2">
						<form:form role="form" method="post"
							modelAttribute="italianMethodLoan" id="servicesform">
											...
											<p class="modal-link last-element">
												<a href="" data-toggle="modal"
													data-target="#modalExplicativo" onclick="drawChart()"><spring:message
														code="label.whatisitalianloan" /></a>
											</p>
										</div>
					...
					<!-- 					Descripción lateral  -->
					<div class="col-md-4">
						<spring:message code="label.s4italianlateral" />
					</div>
				</div>
			</div>
		</section>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align: justify;">
						<p>
							<spring:message code="label.italianmethodloaninfo" />
						</p>
						<p>
							<spring:message code="label.imi2" />
						</p>
						<p>
							<spring:message code="label.imi3" />
						</p>
						<p>
							<spring:message code="label.imi4" />
						</p>
						<p style="text-align: center;">
						<img src="resources/template/images/prestamos/formulaprestamoitaliano.png"/>
						</p>
						<p>
							<spring:message code="label.imi5" />
						</p>
