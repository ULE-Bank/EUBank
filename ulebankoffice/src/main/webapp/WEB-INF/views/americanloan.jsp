...
<meta name="description"
	content="Simulador de préstamo método Americano.">
<meta name="keywords"
	content="ULe-Bank, simulador, calculos, prestamo, metodo, americano">
<meta name="author"
...
<meta name="robots" content="index,follow">
      ...
      <meta property="og:title" content="<spring:message code='label.s4american' />" />
      <meta property="og:url" content="http://ulebank.unileon.es/americanloan" />
      <meta property="og:description" content="<spring:message code='label.s4american'/>"/>
...
<title><spring:message code="label.s4american" /></title>
...
<body>
 ...
 inner-intro-->
		...
		<section
			class="inner-intro grayscale bg-services-loans-american bg-opacity-black-70">
			<div class="container">
				<div class="row text-center intro-title">
					<h1 class="text-blue">
						<spring:message code="label.s4american" />
					</h1>
					<ul class="page-breadcrumb">
						...
						<li><a href="/loans"><spring:message
							...
							class="fa fa-angle-double-right"></i></li>
						<li><span><spring:message code="label.s4american" /></span></li>
					</ul>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-2">
						<form:form role="form" method="post"
							modelAttribute="americanMethodLoan" id="servicesform">
											...
											<p class="modal-link last-element">
												<a href="" data-toggle="modal"
													data-target="#modalExplicativo" onclick="drawChart()"><spring:message
														code="label.whatisamericanloan" /></a>
											</p>
										</div>
					...
					<!-- 					Descripción lateral  -->
					<div class="col-md-4">
						<spring:message code="label.s4americanlateral" />
					</div>
				</div>
			</div>
		</section>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align: justify;">
						<p>
							<spring:message code="label.americanmethodloaninfo" />
						</p>
						<p>
							<spring:message code="label.ami2" />
						</p>
						<p>
							<spring:message code="label.ami3" />
						</p>
						<p>
							<spring:message code="label.ami4" />
						</p>
						<p style="text-align: center;">
						<img src="resources/template/images/prestamos/formulaprestamoamericano.png"/>
						</p>
						<p>
							<spring:message code="label.ami5" />
						</p>
