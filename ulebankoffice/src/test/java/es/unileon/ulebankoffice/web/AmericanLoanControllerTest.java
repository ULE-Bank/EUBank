...
public class AmericanLoanControllerTest {

	@InjectMocks
    private AmericanLoanFormController americanController;
    ...
    public void setup() {
        ...
        vr.setSuffix(".jsp");
        this.mockMvc = MockMvcBuilders.standaloneSetup(americanController)
        		.setViewResolvers(vr)
        		.build();
    }
