...
public class GermanLoanControllerTest {

	@InjectMocks
    private GermanLoanFormController germanController;
    ...
    public void setup() {
        ...
        vr.setSuffix(".jsp");
        this.mockMvc = MockMvcBuilders.standaloneSetup(germanController)
        		.setViewResolvers(vr)
        		.build();
    }
	...
	public void testGetRequest() throws Exception {
		this.mockMvc.perform(get("/germanloan"))
	            .andExpect(status().isOk())
	            .andExpect(forwardedUrl("germanloan.jsp"));
	}
	
	@Test
	public void testPostRequestWithoutErrors() throws Exception {
		this.mockMvc.perform(post("/germanloan")
				.param("C0", "100000")
	            .param("i", "5")
	            .param("k", "3")
	            .param("p", "1"))
