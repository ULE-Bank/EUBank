...
public class ItalianLoanControllerTest {
	
	@InjectMocks
    private ItalianLoanFormController italianController;
    ...
    public void setup() {
        ...
        vr.setSuffix(".jsp");
        this.mockMvc = MockMvcBuilders.standaloneSetup(italianController)
        		.setViewResolvers(vr)
        		.build();
    }
